    ...
    <html lang="en" className="h-full" suppressHydrationWarning>
      ...
      <body className="min-h-full bg-canvas text-ink antialiased">
        <ThemeProvider>
          ...
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-skip focus:rounded-lg focus:bg-brand-600 focus:px-4 focus:py-2 focus:text-white"
          >
            Skip to content
          </a>
          {children}
